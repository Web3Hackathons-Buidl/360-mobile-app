  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      if (accounts.length > 0) {
        ...
        // You can register an event listener for changes to the user's wallet here
      }
    } catch (error) {
      console.error(error);
      setStatus("idle");
        ...
        {isConnected && (
          <div className="flex  w-full justify-center space-x-2">
            ...
            <button
              ...
              className="mt-8 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-ganache text-white px-5 py-3 text-base font-medium  sm:w"
            >
              Disconnect
            </button>
          </div>
